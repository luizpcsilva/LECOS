...
sudo python3 scripts/medicao-processos-cpu-time.py "stress-ng --matrix 0 --matrix-method prod -t 60s" "stress-ng --cpu 0 --cpu-method fibonacci -t 60s" 1 teste-processos.txt
```
